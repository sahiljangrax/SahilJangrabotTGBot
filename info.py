...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002377866578 -1002474788204 -1002015186954 -1002201780176').split()]
...
URL = "https://current-maybelle-sahiljangrabot-8da78e82.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://current-maybelle-sahiljangrabot-8da78e82.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://current-maybelle-sahiljangrabot-8da78e82.koyeb.app/".format(FQDN)
else:
    URL = "https://current-maybelle-sahiljangrabot-8da78e82.koyeb.app/".format(FQDN)
