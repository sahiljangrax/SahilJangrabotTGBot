...
URL = "https://chemical-norine-sahiljangrabot-0bd73b68.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://chemical-norine-sahiljangrabot-0bd73b68.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://chemical-norine-sahiljangrabot-0bd73b68.koyeb.app/".format(FQDN)
else:
    URL = "https://chemical-norine-sahiljangrabot-0bd73b68.koyeb.app/".format(FQDN)
