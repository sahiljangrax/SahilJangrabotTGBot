...
URL = "https://lmmaster-lonelymovies.koyeb.app".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://lmmaster-lonelymovies.koyeb.app".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://lmmaster-lonelymovies.koyeb.app".format(FQDN)
else:
    URL = "https://lmmaster-lonelymovies.koyeb.app".format(FQDN)
